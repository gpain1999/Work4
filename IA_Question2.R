...
print(xtable(orMW, digits = c(0,1,1)), floating = FALSE)
print(xtable(orNE, digits = c(0, 1)), floating = FALSE)
print(xtable(orS, digits = c(0, 1)), floating = FALSE)
print(xtable(orW, digits = c(0, 1)), floating = FALSE)
